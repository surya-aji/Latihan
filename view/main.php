	...
	<html lang="en">
		<head>
			...
			<style>
				...
				.no-skin .sidebar .nav-list li li.open.active>a,
				.no-skin .sidebar .nav-list li li.open>a,
				.no-skin .sidebar .nav-list li li>a {
					...
					<div class="footer-inner">
						<div class="footer-content">
							<span class="bigger-120">
								<span class="blue bolder">E - OFFICE</span>
